...
import RichTextRenderer from "@/components/Package_Detail/Details/RichRender";
        ...
        <div className="grid justify-between grid-cols-12 lg:gap-8 gap-6">
          <div className="lg:col-span-6 col-span-12">
            ...
            <div className="flex flex-col gap-y-8">
              ...
              <div className="overflow-hidden   m-auto shadow-lg dark:shadow-darkmd px-6 rounded-2xl " style={{width: "100%"}}>
